...
class Map:
    class Location:
        ...
        def GetMyLocationWithMinimap():
            ...
            if (not Map.Location.CanUseMinimapForLocation()):
                raise PYGenshinException(
        ...
        def GetMyLocation():
            ...
            if (Map.Location.CanUseMinimapForLocation()):
                return Map.Location.GetMyLocationWithMinimap()
            else:
                return Map.Location.GetMyLocationWithFullMap()
    ...
    class Navigation:
        ...
        def TeleportToItemOnMap(playerPosition: Vector2, item: pgMap.MapItem):
            ...
            teleport = Map.Items.GetClosestItemOfType(
